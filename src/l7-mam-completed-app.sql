...
,p_default_workspace_id=>9948102563706259
...
--   Date and Time:   14:21 Monday June 15, 2020
--   Exported By:     USAGE
--   Flashback:       0
...
,p_last_upd_yyyymmddhh24miss=>'20200615142042'
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(10563122300311636)
,p_list_item_display_sequence=>100
,p_list_item_link_text=>'Usage Record Search'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(10564047945311644)
,p_short_name=>'Usage Record Search'
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'PRD_COMPARTMENT_PATH:PRD_COMPARTMENT_NAME:PRD_REGION:PRD_SERVICE:PRD_RESOURCE:USG_BILLED_QUANTITY:USG_CONSUMED_UNITS:USG_CONSUMED_MEASURE:USAGE_INTERVAL_START:USAGE_INTERVAL_END:TAGS_DATA'
);
wwv_flow_api.create_page_plug(
...
'    and COST_MY_COST > 0',
'    and not (:P4_COMPARTMENT_NAME is null and :P4_PRODUCT_SERVICE is null and :P4_PRODUCT_REGION is null and :P4_COMPARTMENT_TOP is null and :P4_TAG_KEY is null and :P4_TAG_DATA is null and :P4_COST_PRODUCT_SKU is null)',
...
'    USAGE_INTERVAL_START >= to_date(:P4_DATE_FROM,''DD-MON-YYYY HH24:MI'') and USAGE_INTERVAL_START < to_date(:P4_DATE_TO,''DD-MON-YYYY HH24:MI'')',
'    and COST_MY_COST > 0',
'    and (:P4_COMPARTMENT_NAME is null and :P4_PRODUCT_SERVICE is null and :P4_PRODUCT_REGION is null and :P4_COMPARTMENT_TOP is null and :P4_TAG_KEY is null and :P4_TAG_DATA is null and :P4_COST_PRODUCT_SKU is null)',
'    and :P4_REPORT_SELECTOR = ''Cost Per Day''',
'group by ',
'	to_char(USAGE_INTERVAL_START,''YYYY-MM-DD'')',
'order by 1',
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'FILE_ID:USAGE_INTERVAL_START:USAGE_INTERVAL_END:PRD_COMPARTMENT_NAME:PRD_COMPARTMENT_PATH:PRD_AVAILABILITY_DOMAIN:PRD_REGION:PRD_SERVICE:COST_PRODUCT_SKU:PRD_DESCRIPTION:USG_BILLED_QUANTITY:USG_BILLED_QUANTITY_OVERAGE:COST_BILLING_UNIT:COST_UNIT_PRIC'
||'E:COST_UNIT_PRICE_OVERAGE:COST_MY_COST:COST_MY_COST_OVERAGE:COST_CURRENCY_CODE:COST_OVERAGE_FLAG:IS_CORRECTION:TAGS_DATA'
);
wwv_flow_api.create_page_plug(
...
'        (:P4_COST_PRODUCT_SKU is null or COST_PRODUCT_SKU = :P4_COST_PRODUCT_SKU) and',
'        USAGE_INTERVAL_START >= to_date(:P4_DATE_FROM,''DD-MON-YYYY HH24:MI'') and USAGE_INTERVAL_START < to_date(:P4_DATE_TO,''DD-MON-YYYY HH24:MI'') and',
'        not (:P4_COMPARTMENT_NAME is null and :P4_PRODUCT_SERVICE is null and :P4_PRODUCT_REGION is null and :P4_COMPARTMENT_TOP is null and :P4_TAG_KEY is null and :P4_TAG_DATA is null and :P4_COST_PRODUCT_SKU is null)',
'    union all',
'    select ',
'        sum(num_rows) cnt',
'    from oci_cost_stats',
...
'        tenant_name=:P4_TENANT_NAME and',
'        USAGE_INTERVAL_START >= to_date(:P4_DATE_FROM,''DD-MON-YYYY HH24:MI'') and USAGE_INTERVAL_START < to_date(:P4_DATE_TO,''DD-MON-YYYY HH24:MI'') and',
'        (:P4_COMPARTMENT_NAME is null and :P4_PRODUCT_SERVICE is null and :P4_PRODUCT_REGION is null and :P4_COMPARTMENT_TOP is null and :P4_TAG_KEY is null and :P4_TAG_DATA is null and :P4_COST_PRODUCT_SKU is null)',
')'))
,p_source_type=>'QUERY'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_colspan=>4
...
'        (:P4_COST_PRODUCT_SKU is null or COST_PRODUCT_SKU = :P4_COST_PRODUCT_SKU) and',
'        USAGE_INTERVAL_START >= to_date(:P4_DATE_FROM,''DD-MON-YYYY HH24:MI'') and USAGE_INTERVAL_START < to_date(:P4_DATE_TO,''DD-MON-YYYY HH24:MI'') and',
'        not (:P4_COMPARTMENT_NAME is null and :P4_PRODUCT_SERVICE is null and :P4_PRODUCT_REGION is null and :P4_COMPARTMENT_TOP is null and ',
...
||'ent;Cost Per Single Compartment,Cost Report;Cost Report,Cost Explorer;Cost Explorer'
,p_cHeight=>1
,p_begin_on_new_line=>'N'
,p_colspan=>3
,p_field_template=>wwv_flow_api.id(9820028477688087)
...
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'STATIC2:Product;Product,Region;Region,Top Compartment;Top Compartment,Compartment;Compartment'
,p_cHeight=>1
,p_begin_on_new_line=>'N'
,p_colspan=>2
,p_field_template=>wwv_flow_api.id(9820028477688087)
...
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>'USAGE'
,p_last_upd_yyyymmddhh24miss=>'20200615141406'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(11749857121957301)
,p_plug_name=>'Data Uploaded'
...
,p_plug_display_point=>'BODY'
,p_plug_source_type=>'NATIVE_JET_CHART'
,p_ajax_items_to_submit=>'P6_TENANT'
,p_plug_query_num_rows=>15
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
);
wwv_flow_api.create_jet_chart(
 p_id=>wwv_flow_api.id(11749931566957302)
,p_region_id=>wwv_flow_api.id(11749857121957301)
,p_chart_type=>'bar'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'auto'
,p_orientation=>'vertical'
...
wwv_flow_api.create_jet_chart_series(
 p_id=>wwv_flow_api.id(11750045361957303)
,p_chart_id=>wwv_flow_api.id(11749931566957302)
,p_seq=>10
,p_name=>'OCI Usage Stats Rows'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_items_value_column_name=>'US_NUM_ROWS'
,p_items_label_column_name=>'FILE_DATE'
,p_assigned_to_y2=>'off'
,p_items_label_rendered=>false
);
wwv_flow_api.create_jet_chart_series(
 p_id=>wwv_flow_api.id(11750647215957309)
,p_chart_id=>wwv_flow_api.id(11749931566957302)
,p_seq=>20
,p_name=>'Rows uploaded per tenancy '
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'Select trunc(us.USAGE_INTERVAL_START) FILE_DATE,',
'sum(us.num_rows) as us_num_rows',
...
wwv_flow_api.create_jet_chart_axis(
 p_id=>wwv_flow_api.id(11750126659957304)
,p_chart_id=>wwv_flow_api.id(11749931566957302)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_title=>'Date Captured'
...
wwv_flow_api.create_jet_chart_axis(
 p_id=>wwv_flow_api.id(11750275025957305)
,p_chart_id=>wwv_flow_api.id(11749931566957302)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_title=>'Number of rows'
,p_format_type=>'decimal'
,p_format_scaling=>'auto'
,p_scaling=>'linear'
,p_baseline_scaling=>'zero'
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'TENANT_NAME:MIN_FILE_TIME:MAX_FILE_TIME:MIN_FILE_ID:MAX_FILE_ID:NUM_FILES:NUM_ROWS:AVG_COST_DAY:MAX_COST_DAY:NUM_FULL_DAYS:LAST_LOAD:AGENT_VERSION'
,p_sum_columns_on_break=>'NUM_ROWS:NUM_FILES'
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(11750348236957306)
,p_name=>'P6_TENANT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(11749857121957301)
,p_prompt=>'Tenant'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'select distinct tenant_name o, tenant_name r from usage.oci_usage order by 1 ;'
,p_cHeight=>1
,p_colspan=>2
,p_field_template=>wwv_flow_api.id(9820028477688087)
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(11750495546957307)
,p_name=>'Set Tenancy'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P6_TENANT'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
);
end;
...
begin
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(11750562772957308)
,p_event_id=>wwv_flow_api.id(11750495546957307)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(11749857121957301)
);
null;
end;
/
...
wwv_flow_api.create_page(
 p_id=>11
,p_user_interface_id=>wwv_flow_api.id(9843694399688199)
,p_name=>'Usage Record Search'
,p_step_title=>'Usage Record Search'
,p_autocomplete_on_off=>'OFF'
,p_step_template=>wwv_flow_api.id(9715583223687903)
,p_page_template_options=>'#DEFAULT#'
,p_protection_level=>'C'
,p_last_updated_by=>'USAGE'
,p_last_upd_yyyymmddhh24miss=>'20200612164512'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(10563683767311642)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(9774426068688028)
,p_plug_display_sequence=>10
,p_plug_display_point=>'REGION_POSITION_01'
,p_menu_id=>wwv_flow_api.id(9714771272687883)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>wwv_flow_api.id(9822555663688101)
);
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(10564217255311645)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(10567460125311664)
,p_query_column_id=>1
,p_column_alias=>'TENANT_NAME'
,p_column_display_sequence=>1
,p_column_heading=>'Tenant Name'
,p_heading_alignment=>'LEFT'
,p_disable_sort_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(10567877171311667)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(10568208627311667)
,p_query_column_id=>3
,p_column_alias=>'USAGE_INTERVAL_START'
,p_column_display_sequence=>3
,p_column_heading=>'Usage Interval Start'
,p_column_alignment=>'CENTER'
,p_disable_sort_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(10568600090311667)
,p_query_column_id=>4
,p_column_alias=>'USAGE_INTERVAL_END'
,p_column_display_sequence=>4
,p_column_heading=>'Usage Interval End'
,p_column_alignment=>'CENTER'
,p_disable_sort_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(10569082044311667)
,p_query_column_id=>5
,p_column_alias=>'PRD_SERVICE'
,p_column_display_sequence=>5
,p_column_heading=>'Prd Service'
,p_heading_alignment=>'LEFT'
,p_disable_sort_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(10569439619311668)
,p_query_column_id=>6
,p_column_alias=>'PRD_RESOURCE'
,p_column_display_sequence=>6
,p_column_heading=>'Prd Resource'
,p_heading_alignment=>'LEFT'
,p_disable_sort_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(10569852248311668)
,p_query_column_id=>7
,p_column_alias=>'PRD_COMPARTMENT_ID'
,p_column_display_sequence=>7
,p_column_heading=>'Prd Compartment ID'
,p_heading_alignment=>'LEFT'
,p_disable_sort_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(10570212695311668)
,p_query_column_id=>8
,p_column_alias=>'PRD_COMPARTMENT_NAME'
,p_column_display_sequence=>8
,p_column_heading=>'Prd Compartment Name'
,p_heading_alignment=>'LEFT'
,p_disable_sort_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(10570662967311668)
,p_query_column_id=>9
,p_column_alias=>'PRD_COMPARTMENT_PATH'
,p_column_display_sequence=>9
,p_column_heading=>'Prd Compartment Path'
,p_heading_alignment=>'LEFT'
,p_disable_sort_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(10571044360311669)
,p_query_column_id=>10
,p_column_alias=>'PRD_REGION'
,p_column_display_sequence=>10
,p_column_heading=>'Prd Region'
,p_heading_alignment=>'LEFT'
,p_disable_sort_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(10571406624311669)
,p_query_column_id=>11
,p_column_alias=>'PRD_AVAILABILITY_DOMAIN'
,p_column_display_sequence=>11
,p_column_heading=>'Prd Availability Domain'
,p_heading_alignment=>'LEFT'
,p_disable_sort_column=>'N'
,p_hidden_column=>'Y'
,p_include_in_export=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(10564303465311645)
,p_plug_name=>'Search'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(9740024261687991)
,p_plug_display_sequence=>10
,p_plug_grid_column_span=>4
,p_plug_display_point=>'REGION_POSITION_02'
,p_plug_source_type=>'NATIVE_FACETED_SEARCH'
,p_filtered_region_id=>wwv_flow_api.id(10564217255311645)
,p_attribute_01=>'N'
,p_attribute_06=>'N'
,p_attribute_07=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(10564892145311645)
,p_name=>'P11_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(10564303465311645)
,p_prompt=>'Search'
,p_source=>'TENANT_NAME,FILE_ID,PRD_SERVICE,PRD_RESOURCE,PRD_COMPARTMENT_ID,PRD_COMPARTMENT_NAME,PRD_COMPARTMENT_PATH,PRD_REGION'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(10565686071311646)
,p_name=>'P11_PRD_SERVICE'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(10566078621311646)
,p_name=>'P11_PRD_RESOURCE'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(10564303465311645)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(10566428681311647)
,p_name=>'P11_PRD_COMPARTMENT_NAME'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(10564303465311645)
,p_prompt=>'Prd Compartment Name'
,p_source=>'PRD_COMPARTMENT_NAME'
,p_source_type=>'FACET_COLUMN'
,p_display_as=>'NATIVE_CHECKBOX'
,p_fc_collapsible=>true
,p_fc_initial_collapsed=>false
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(10566851270311647)
,p_name=>'P11_TENANT_NAME'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(10564303465311645)
,p_prompt=>'Tenant Name'
,p_source=>'TENANT_NAME'
,p_source_type=>'FACET_COLUMN'
,p_display_as=>'NATIVE_CHECKBOX'
,p_fc_collapsible=>true
,p_fc_initial_collapsed=>false
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(11359356590785701)
,p_name=>'P11_PRD_REGION'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>25
,p_item_plug_id=>wwv_flow_api.id(10564303465311645)
,p_prompt=>'Oracle OCI Region'
,p_source=>'PRD_REGION'
,p_source_type=>'FACET_COLUMN'
,p_display_as=>'NATIVE_CHECKBOX'
,p_item_template_options=>'#DEFAULT#'
